...
def main():
    ...
    for strategy in strategies:
        ...
        strategy_output_dir = os.path.join(config.RESULTS_DIR, strategy)
    ...
    comparison_df.to_csv(
        os.path.join(config.RESULTS_DIR, 'strategy_comparison.csv'), 
        index=False
    )
    print(f"\nSaved final comparison to {config.RESULTS_DIR}")
